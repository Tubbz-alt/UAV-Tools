...
public class SimpleLine{
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        JButton btmAddRandomLine = new JButton("Line");
        btmAddRandomLine.addActionListener((event)->{
            //Create a line in a random position
            double size = 0.0003;
            double dlat = (1-Math.random()*2)/1000.0;
            double dlng = (1-Math.random()*2)/1000.0;
            double lat = -27.573252+dlat;
